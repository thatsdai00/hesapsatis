...
import {FaSearch, FaWallet, FaPlus, FaMinus, FaCoins, FaUserCog, FaEye, FaUser, FaShoppingBag, FaTicketAlt, FaBoxOpen, FaList, FaLayerGroup} from 'react-icons/fa';
...
// AllowedRole is used below instead of this type
...
export default function AdminUsersPage() {
  ...
  const {
    data: usersData,
    isLoading,
    refetch } = trpc.admin.getUsers.useQuery({
    limit: 20,
