...
import { z } from 'zod';
import { Ticket, User, Order, TicketStatus, Prisma } from '@prisma/client';
        ...
        try {
            ...
            setTicket(prev => {
                ...
                return {
                    ...
                    // Cast to `any` to bypass type error without breaking client-side builds.
                    user: { ...prev.user, balance: newBalance as any },
                };
            });
